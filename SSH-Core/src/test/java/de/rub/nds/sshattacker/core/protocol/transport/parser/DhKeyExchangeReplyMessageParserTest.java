...
public class DhKeyExchangeReplyMessageParserTest {
        ...
        return Stream.of(
                Arguments.of(
                        ArrayConverter.hexStringToByteArray(
                                "1F000000680000001365636473612d736861322d6e69737470323536000000086e69737470323536000000410435496f94112c3234092471322c26dd21ebfd2da156e5a17dcc5dc98020afedd64ae82e5d4c28251187a2191fe85ae43de9734711c087b784eaa713d5b6e06541"
    ...
    public void testParse(
        ...
        DhKeyExchangeReplyMessageParser parser =
                new DhKeyExchangeReplyMessageParser(new ByteArrayInputStream(providedBytes));
        DhKeyExchangeReplyMessage msg = new DhKeyExchangeReplyMessage();
        parser.parse(msg);
