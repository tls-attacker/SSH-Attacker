...
import de.rub.nds.sshattacker.core.protocol.connection.parser.GlobalRequestMessageParser;
...
public class CyclicGlobalRequestMessageParserTest {
    /**
    ...
    /**
     * Cyclic test for parsing and serializing of GlobalRequestMessage
     *
     * @param providedBytes
    ...
    public void testCyclic(byte[] providedBytes) {
        GlobalRequestMessage msg = new GlobalRequestMessageParser(0, providedBytes).parse();
        assertArrayEquals(providedBytes, new GlobalRequestMessageSerializer(msg).serialize());
    }
}
