...
public class RsaKeyExchangeTest {
         ...
         * computations(testRsaKeyExchangeDecryption/ testRsaKeyExchangeEncryption) unit
         * test from
        ...
        public static Stream<Arguments> provideTestVectors(String file) {
                InputStream testVectorFile = RsaKeyExchange.class.getClassLoader().getResourceAsStream(file);
        ...
        /**
         * Tests the rsa key exchange decryption by computing the shared secret from the
         * given
         * ciphertext, according to the mpint computations standarized in SSH. Thus the
         * method tests the
        ...
        public void testRsaKeyExchangeDecryption(
                ...
                RsaKeyExchange rsaKeyExchange = RsaKeyExchange.newInstance(new SshContext(), keyExchangeAlgorithm);
                CustomRsaPublicKey publicKey = new CustomRsaPublicKey(publicKeyExponent, publicKeyModulus);
                CustomRsaPrivateKey privateKey = new CustomRsaPrivateKey(privateKeyExponent, privateKeyModulus);
                SshPublicKey<CustomRsaPublicKey, CustomRsaPrivateKey> keypair = new SshPublicKey<>(
                                PublicKeyFormat.SSH_RSA, publicKey, privateKey);
        ...
        /**
         * Tests the rsa key exchange encryption by computing the ciphertext from the
         * given plaintext
         * and decrypting it again, according to the mpint computations standarized in
         * SSH. If
         * testRsaKeyexchangeDecryption is working the right way, this method verifies
         * the encryption
         * method of RsaKeyExchange. Thus the method test the class RsaKeyExchange.java
         * and all
         * underlying classes.
         *
        ...
        public void exceptionTesting() {
                ...
                BigInteger publicExponent = new BigInteger(
                                ...
                                16);
                byte[] wrongInput = ArrayConverter.hexStringToByteArray(
                ...
                RsaKeyExchange rsaKeyExchange = RsaKeyExchange.newInstance(new SshContext(),
