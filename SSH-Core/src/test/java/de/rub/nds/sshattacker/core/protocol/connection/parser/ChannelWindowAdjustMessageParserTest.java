...
public class ChannelWindowAdjustMessageParserTest {
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(
                ...
                Arguments.of(
                        ArrayConverter.hexStringToByteArray("5DFFFFFFFF000004D2"),
     ...
     * @param expectedRecipientChannel Expected channel number to add bytes to
     * @param expectedBytesToAdd Expected number of bytes to add to the window size
     */
    @ParameterizedTest
    ...
    public void testParse(
        ...
        assertEquals(
                MessageIDConstant.SSH_MSG_CHANNEL_WINDOW_ADJUST.id, msg.getMessageID().getValue());
