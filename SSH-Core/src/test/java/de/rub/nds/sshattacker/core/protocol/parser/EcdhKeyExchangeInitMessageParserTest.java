...
public class EcdhKeyExchangeInitMessageParserTest {
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(Arguments.of(ArrayConverter
                .hexStringToByteArray("1E00000020c3579aa0b92395e888ed16a546587c5d8879f0f2f813b2bc68bab3325b9a6f0f"),
                32, ArrayConverter
     ...
     *            Expected length of the public key
     * @param expectedPublicKey
     *            Expected bytes of the public key
     */
    @ParameterizedTest
    @MethodSource("provideTestVectors")
    public void testParse(byte[] providedBytes, int expectedPublicKeyLength, byte[] expectedPublicKey) {
        EcdhKeyExchangeInitMessageParser parser = new EcdhKeyExchangeInitMessageParser(0, providedBytes);
