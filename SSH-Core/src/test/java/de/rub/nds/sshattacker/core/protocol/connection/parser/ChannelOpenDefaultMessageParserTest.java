...
public class ChannelOpenDefaultMessageParserTest {
    /**
    ...
    public void testParse(
        ...
        ChannelOpenDefaultMessageParser parser = new ChannelOpenDefaultMessageParser(providedBytes);
        ChannelOpenDefaultMessage msg = parser.parse();
