...
public class ChannelOpenFailureMessageParserTest {
        ...
        return Stream.of(
                Arguments.of(
                        ArrayConverter.hexStringToByteArray(
                                "5C0000000000000004000000155265736F757263657320756E617661696C61626C6500000002454E"),
                        0,
                        4,
                ...
                Arguments.of(
                        ArrayConverter.hexStringToByteArray(
                                "5C000000100000000100000009466F7262696464656E00000002454E"),
                        16,
                        1,
                        "Forbidden",
                        "EN"));
     ...
     * @param expectedReasonCode Expected reason code
     * @param expectedReason Expected reason string
    ...
    public void testParse(
        ...
        ChannelOpenFailureMessageParser parser =
                new ChannelOpenFailureMessageParser(new ByteArrayInputStream(providedBytes));
