...
public class RsaKeyExchangeSecretMessageSerializerTest {
    ...
    public void testSerialize(byte[] expectedBytes, int providedEncryptedSecretLength, byte[] providedEncryptedSecret) {
        ...
        RsaKeyExchangeSecretMessageSerializer serializer = new RsaKeyExchangeSecretMessageSerializer(msg);
