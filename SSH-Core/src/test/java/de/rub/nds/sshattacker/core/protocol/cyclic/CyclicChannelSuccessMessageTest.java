...
import de.rub.nds.sshattacker.core.protocol.parser.ChannelSuccessMessageParser;
...
public class CyclicChannelSuccessMessageTest {
    /**
    ...
    /**
     * Cyclic test for parsing and serializing of ChannelSuccessMessages
     *
     * @param providedBytes
    ...
    public void testCyclic(byte[] providedBytes) {
        ChannelSuccessMessage msg = new ChannelSuccessMessageParser(0, providedBytes).parse();
        assertArrayEquals(providedBytes, new ChannelSuccessMessageSerializer(msg).serialize());
    }
}
