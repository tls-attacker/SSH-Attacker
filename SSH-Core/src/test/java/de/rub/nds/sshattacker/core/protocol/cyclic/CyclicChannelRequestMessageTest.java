...
import de.rub.nds.sshattacker.core.protocol.connection.parser.ChannelRequestMessageParser;
...
public class CyclicChannelRequestMessageTest {
    /**
    ...
    /**
     * Cyclic test for parsing and serializing of ChannelRequestMessages
     *
     * @param providedBytes
    ...
    public void testCyclic(byte[] providedBytes) {
        ChannelRequestMessage msg = new ChannelRequestMessageParser(0, providedBytes).parse();
        assertArrayEquals(providedBytes, new ChannelRequestMessageSerializer(msg).serialize());
    }
}
