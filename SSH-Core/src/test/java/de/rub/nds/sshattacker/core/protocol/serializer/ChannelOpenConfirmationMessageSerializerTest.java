...
public class ChannelOpenConfirmationMessageSerializerTest {
     ...
     * @param providedSenderChannel
     *            Sender channel number
     * @param providedInitialWindowSize
     *            Initial window size
     * @param providedMaximumPacketSize
     *            Maximum packet size
     */
    @ParameterizedTest
    @MethodSource("provideTestVectors")
    public void testSerialize(byte[] expectedBytes, int providedRecipientChannel, int providedSenderChannel,
            int providedInitialWindowSize, int providedMaximumPacketSize) {
        ChannelOpenConfirmationMessage msg = new ChannelOpenConfirmationMessage();
        msg.setMessageID(MessageIDConstant.SSH_MSG_CHANNEL_OPEN_CONFIRMATION.id);
        ...
        ChannelOpenConfirmationMessageSerializer serializer = new ChannelOpenConfirmationMessageSerializer(msg);
