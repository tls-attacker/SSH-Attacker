...
public class ServiceAcceptMessageParserTest {
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(Arguments.of(ArrayConverter.hexStringToByteArray("060000000C7373682D7573657261757468"),
                ServiceType.SSH_USERAUTH), Arguments.of(
                ArrayConverter.hexStringToByteArray("060000000E7373682D636F6E6E656374696F6E"),
    ...
    public void testParse(byte[] providedBytes, ServiceType expectedServiceType) {
        ServiceAcceptMessageParser parser = new ServiceAcceptMessageParser(0, providedBytes);
