...
public class KeyDerivationTest {
    ...
    public void testComputeECDHExchangeHash() throws CryptoException {
        ...
        new EcdhKeyExchangeInitMessageParser(
                ...
                .parse(ecdhInit);
        EcdhKeyExchangeReplyMessage ecdhReply = new EcdhKeyExchangeReplyMessage();
        ...
        KeyExchangeInitMessage serverKeyExchangeInitMessage = new KeyExchangeInitMessage();
        KeyExchangeInitMessage clientKeyExchangeInitMessage = new KeyExchangeInitMessage();
        new KeyExchangeInitMessageParser(
                ...
                .parse(serverKeyExchangeInitMessage);
        inputHolder.setClientKeyExchangeInit(serverKeyExchangeInitMessage);
        ...
        new KeyExchangeInitMessageParser(
                ...
                .parse(clientKeyExchangeInitMessage);
        inputHolder.setServerKeyExchangeInit(clientKeyExchangeInitMessage);
