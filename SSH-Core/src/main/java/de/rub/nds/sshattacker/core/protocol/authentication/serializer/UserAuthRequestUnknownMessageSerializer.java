...
public class UserAuthRequestUnknownMessageSerializer
        extends UserAuthRequestMessageSerializer<UserAuthRequestUnknownMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public UserAuthRequestUnknownMessageSerializer(UserAuthRequestUnknownMessage message) {
        super(message);
    }
