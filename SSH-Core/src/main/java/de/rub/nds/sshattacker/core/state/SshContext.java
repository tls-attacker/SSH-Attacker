...
public class SshContext {
    ...
    /**
     * Server host keys, sent by hostkey00 message and specification of which were requested by the
     * client in hostkeys-prove-00@openssh.com to be proven by signature creation of the server
     */
    private HashMap<SshPublicKey<?, ?>, Boolean> serverHostKeys = new HashMap<>();
    ...
    public HashMap<SshPublicKey<?, ?>, Boolean> getServerHostKeys() {
    ...
    public void setServerHostKeys(HashMap<SshPublicKey<?, ?>, Boolean> serverHostKeys) {
