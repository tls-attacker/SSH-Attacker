...
public abstract class EllipticCurve {
     ...
     *
     * @param p
     *            An affine point whose coordinates are elements of the field over which the curve is defined or the
     *            point at infinity.
     */
     ...
     *            An affine point whose coordinates are elements of the field over which the curve is defined.
     * @param q
     *            An affine point whose coordinates are elements of the field over which the curve is defined. Must not
     *            be equal to -p.
     */
