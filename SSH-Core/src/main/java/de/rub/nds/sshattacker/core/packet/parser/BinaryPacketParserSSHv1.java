...
public class BinaryPacketParserSSHv1 extends AbstractPacketParser<BinaryPacketSSHv1> {
    ...
    */
    ...
    private void parseAEADPacket(BinaryPacketSSHv1 binaryPacket) {
        /*
    ...
    private void parseChaCha20Poly1305Packet(BinaryPacketSSHv1 binaryPacket)
    ...
    private void parseETMPacket(BinaryPacketSSHv1 binaryPacket) {
        /*
    ...
    private void parseEAMPacket(BinaryPacketSSHv1 binaryPacket) throws CryptoException {
        ...
        int paddingLenght = 8 - (binaryPacket.getLength().getValue() % 8);
