...
public class Sntrup761X25519KeyExchange extends HybridKeyExchange {
    ...
    public Sntrup761X25519KeyExchange() {
        super(new XCurveEcdhKeyExchange(NamedEcGroup.CURVE25519), new Sntrup761KeyExchange(),
                HybridPublicKeyCombiner.POSTQUANTUM_CONCATENATE_CLASSICAL,
                CryptoConstants.X25519_POINT_SIZE, CryptoConstants.SNTRUP761_PUBLIC_KEY_SIZE, 0);
    }
        ...
        try {
            ...
            LOGGER.debug(
                    "Encoded Shared Secret: "
                            + ArrayConverter.bytesToRawHexString(encode(tmpSharedSecret, "SHA-512")));
        } catch (Exception e) {
