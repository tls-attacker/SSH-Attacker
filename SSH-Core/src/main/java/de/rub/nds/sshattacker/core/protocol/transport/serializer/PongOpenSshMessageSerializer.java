...
public class PongOpenSshMessageSerializer extends SshMessageSerializer<PongOpenSshMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public PongOpenSshMessageSerializer(PongOpenSshMessage message) {
        super(message);
    }
