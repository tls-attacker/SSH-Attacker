...
public class UserAuthRequestPasswordMessageSerializer
        extends UserAuthRequestMessageSerializer<UserAuthRequestPasswordMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    private static void serializeChangePassword(
            UserAuthRequestPasswordMessage object, SerializerStream output) {
    ...
    private static void serializePassword(
            UserAuthRequestPasswordMessage object, SerializerStream output) {
