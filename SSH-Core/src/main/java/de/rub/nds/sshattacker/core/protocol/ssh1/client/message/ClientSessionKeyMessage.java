...
import de.rub.nds.sshattacker.core.protocol.ssh1.client.handler.ClientSessionKeyMessageHandler;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.parser.ClientSessionKeyMessageParser;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.preparator.ClientSessionKeyMessagePreparator;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.serializer.ClientSessionKeyMessageSerializer;
...
public class ClientSessionKeyMessage extends Ssh1Message<ClientSessionKeyMessage> {
    ...
    @Override
    public ClientSessionKeyMessageHandler getHandler(SshContext sshContext) {
        return new ClientSessionKeyMessageHandler(sshContext);
    }
    ...
    @Override
    public Ssh1MessagePreparator<ClientSessionKeyMessage> getPreparator(SshContext sshContext) {
        return new ClientSessionKeyMessagePreparator(sshContext.getChooser(), this);
    }

    @Override
    public Ssh1MessageSerializer<ClientSessionKeyMessage> getSerializer(SshContext sshContext) {
        return new ClientSessionKeyMessageSerializer(this);
    }

    @Override
    public String toShortString() {
        return "SSH_CMSG_SESSION_KEY";
    }
}
