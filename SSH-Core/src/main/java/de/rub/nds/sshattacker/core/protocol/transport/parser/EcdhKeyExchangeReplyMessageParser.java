...
public class EcdhKeyExchangeReplyMessageParser extends MessageParser<EcdhKeyExchangeReplyMessage> {
    ...
    private void parsePublicKey(EcdhKeyExchangeReplyMessage msg) {
        ...
        msg.setEphemeralPublicKey(
                parseByteArrayField(msg.getEphemeralPublicKeyLength().getValue()));
        LOGGER.debug(
                "Public key: "
                        + ArrayConverter.bytesToRawHexString(
                                msg.getEphemeralPublicKey().getValue()));
    }
    ...
    private void parseSignature(EcdhKeyExchangeReplyMessage msg) {
        ...
        LOGGER.debug(
                "Signature :" + ArrayConverter.bytesToRawHexString(msg.getSignature().getValue()));
    }
