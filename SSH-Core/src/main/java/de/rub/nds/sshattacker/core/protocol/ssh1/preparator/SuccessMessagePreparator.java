...
public class SuccessMessagePreparator extends SshMessagePreparator<SuccessMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public SuccessMessagePreparator(Chooser chooser, SuccessMessage message) {
