...
public class ChannelRequestPtyReqMessageParser
        extends ChannelRequestMessageParser<ChannelRequestPtyReqMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelRequestPtyReqMessageParser(byte[] array) {
        super(array);
    }

    public ChannelRequestPtyReqMessageParser(byte[] array, int startPosition) {
        super(array, startPosition);
    }

    @Override
    public ChannelRequestPtyReqMessage createMessage() {
        return new ChannelRequestPtyReqMessage();
    }
