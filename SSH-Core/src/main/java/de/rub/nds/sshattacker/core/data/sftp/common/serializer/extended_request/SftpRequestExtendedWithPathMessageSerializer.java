...
import de.rub.nds.sshattacker.core.data.sftp.common.message.extended_request.SftpRequestExtendedWithPathMessage;
...
public abstract class SftpRequestExtendedWithPathMessageSerializer<
    ...
    protected void serializeRequestExtendedSpecificContents(T object, SerializerStream output) {
        ...
        serializeRequestExtendedWithPathSpecificContents(object, output);
    }
