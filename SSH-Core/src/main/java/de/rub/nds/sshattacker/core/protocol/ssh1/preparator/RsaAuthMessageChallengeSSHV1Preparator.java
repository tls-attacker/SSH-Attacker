...
public class RsaAuthMessageChallengeSSHV1Preparator extends SshMessagePreparator<RsaAuthChallengeMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public RsaAuthMessageChallengeSSHV1Preparator(Chooser chooser, RsaAuthChallengeMessageSSH1 message) {
