...
public class ChannelRequestPtyReqMessageSerializer
        extends ChannelRequestMessageSerializer<ChannelRequestPtyReqMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelRequestPtyReqMessageSerializer(ChannelRequestPtyReqMessage message) {
        super(message);
    }
