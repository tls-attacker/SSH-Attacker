...
public class StdoutDataMessageSSHV1Serializier
        extends Ssh1MessageSerializer<StdoutDataMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public StdoutDataMessageSSHV1Serializier(StdoutDataMessageSSH1 message) {
        super(message);
    }
