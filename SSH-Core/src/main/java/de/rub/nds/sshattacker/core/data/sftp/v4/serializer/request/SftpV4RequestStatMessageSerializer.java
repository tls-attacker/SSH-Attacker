...
public class SftpV4RequestStatMessageSerializer
        extends SftpRequestWithPathMessageSerializer<SftpV4RequestStatMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    private static void serializeFlags(SftpV4RequestStatMessage object, SerializerStream output) {
    ...
    protected void serializeRequestWithPathSpecificContents(
            SftpV4RequestStatMessage object, SerializerStream output) {
