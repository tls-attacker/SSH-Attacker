...
import de.rub.nds.sshattacker.core.data.sftp.common.handler.response.SftpResponseDataMessageHandler;
...
public class SftpResponseDataMessage extends SftpResponseMessage<SftpResponseDataMessage> {
    ...
    public static final SftpResponseDataMessageHandler HANDLER =
            new SftpResponseDataMessageHandler();

    @Override
    public SftpResponseDataMessageHandler getHandler() {
        return HANDLER;
    }
