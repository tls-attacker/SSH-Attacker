...
public class TransportLayer extends ProtocolLayer<PacketLayerHint, AbstractPacket> {
    ...
    public LayerProcessingHint parseMessageId(AbstractPacket packet, SshContext context) {
        ...
        LOGGER.debug("Layertype: {}", this.getHigherLayer().getLayerType());

        LayerType upperLayer = this.getHigherLayer().getLayerType();

        if (upperLayer.getName().equals("SSHv1")) {
        ...
        } else if (upperLayer.getName().equals("SSHv2")) {
            ...
            switch (id) {
                ...
                case SSH_MSG_USERAUTH_PASSWD_CHANGEREQ:
                    ...
                    return new PacketLayerHint(
                            ProtocolMessageType.SSH_MSG_USERAUTH_PASSWD_CHANGEREQ);
                ...
                case SSH_MSG_USERAUTH_GSSAPI_RESPONSE:
                    ...
                    return new PacketLayerHint(
                            ProtocolMessageType.SSH_MSG_USERAUTH_GSSAPI_RESPONSE);
            ...
            LOGGER.warn("Unkonwn or Unsupported Layer-Type");
            throw new RuntimeException();
        }
        /*
        MessageIdConstant id =
        ...
        /*switch (MessageIdConstantSSH1.fromId(id,context.getContext())) {
            case SSH_MSG_DISCONNECT:
                LOGGER.debug("[bro] returning SSH_MSG_DISCONNECT Hint");
                return new PacketLayerHint(ProtocolMessageType.SSH_MSG_DISCONNECT);
            case SSH_MSG_IGNORE:
