...
public enum KeyExchangeAlgorithm {
        ...
        /**
         * Indicates whether the algorithm has been already been implemented. However,
         * the algorithm
         * might not be available at runtime. To check if an algorithm is available, use
         * {@link
         * #isAvailable} instead.
         *
        ...
        /**
         * Indicates whether an algorithm is available at runtime. Some algorithms may
         * not be available
