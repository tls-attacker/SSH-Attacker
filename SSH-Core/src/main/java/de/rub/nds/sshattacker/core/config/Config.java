...
public class Config implements Serializable {
    ...
    @XmlElementWrapper
    private List<SshPublicKey<?, ?>> userKeys = new ArrayList<>();
    // endregion
    ...
    public Config() {
        ...
        addUserKeys("keys/id_ecdsa", "keys/id_rsa", "keys/id_dsa", "keys/id_ed25519");
        // endregion
    ...
    public void addUserKeys(String... pathlist) {
