...
public enum MacAlgorithm {
     ...
     */
    // [ RFC 4253 ]
    HMAC_SHA1("hmac-sha1", 20, 20, "HMac-SHA1"),
    HMAC_SHA1_96("hmac-sha1-96", 20, 12, "HMac-SHA1"),
    HMAC_MD5("hmac-md5", 16, 16, "HMac-MD5"),
    HMAC_MD5_96("hmac-md5-96", 16, 12, "HMac-MD5"),
    NONE("none", 0, 0),
    // [ RFC 5647 ]
    AEAD_AES_128_GCM("AEAD_AES_128_GCM", 16, 16),
    AEAD_AES_256_GCM("AEAD_AES_256_GCM", 32, 16),
    // [ RFC 6668 ]
    HMAC_SHA2_256("hmac-sha2-256", 32, 32, "HMac-SHA256"),
    HMAC_SHA2_512("hmac-sha2-512", 64, 64, "HMac-SHA512"),
    // Vendor extensions
    // [ OpenSSH ]
    ...
    HMAC_SHA1_ETM_OPENSSH_COM("hmac-sha1-etm@openssh.com", 20, 20, true, "HMac-SHA1"),
    HMAC_SHA1_96_ETM_OPENSSH_COM("hmac-sha1-96-etm@openssh.com", 20, 12, true, "HMac-SHA1"),
    HMAC_MD5_ETM_OPENSSH_COM("hmac-md5-etm@openssh.com", 16, 16, true, "HMac-MD5"),
    HMAC_MD5_96_ETM_OPENSSH_COM("hmac-md5-96-etm@openssh.com", 16, 12, true, "HMac-MD5"),
    HMAC_SHA2_256_ETM_OPENSSH_COM("hmac-sha2-256-etm@openssh.com", 32, 32, true, "HMac-SHA256"),
    HMAC_SHA2_512_ETM_OPENSSH_COM("hmac-sha2-512-etm@openssh.com", 64, 64, true, "HMac-SHA512"),
