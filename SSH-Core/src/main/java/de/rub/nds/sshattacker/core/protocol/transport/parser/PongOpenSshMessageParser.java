...
public class PongOpenSshMessageParser extends SshMessageParser<PongOpenSshMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public PongOpenSshMessageParser(byte[] array) {
        super(array);
    }

    public PongOpenSshMessageParser(byte[] array, int startPosition) {
        super(array, startPosition);
    }

    @Override
    protected PongOpenSshMessage createMessage() {
        return new PongOpenSshMessage();
    }
