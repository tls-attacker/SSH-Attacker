...
public class PingOpenSshMessageSerializer extends SshMessageSerializer<PingOpenSshMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public PingOpenSshMessageSerializer(PingOpenSshMessage message) {
        super(message);
    }
