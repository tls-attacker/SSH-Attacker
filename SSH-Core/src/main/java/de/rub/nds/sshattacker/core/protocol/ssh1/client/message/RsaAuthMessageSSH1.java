...
import de.rub.nds.sshattacker.core.protocol.ssh1.client.handler.RsaAuthMessageSSHV1Handler;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.parser.RsaAuthMessageSSHV1Parser;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.preparator.RsaAuthMessageSSHV1Preparator;
import de.rub.nds.sshattacker.core.protocol.ssh1.client.serializer.RsaAuthMessageSSHV1Serializier;
...
public class RsaAuthMessageSSH1 extends Ssh1Message<RsaAuthMessageSSH1> {
    ...
    @Override
    public RsaAuthMessageSSHV1Handler getHandler(SshContext sshContext) {
        return new RsaAuthMessageSSHV1Handler(sshContext);
    }
    ...
    @Override
    public Ssh1MessagePreparator<RsaAuthMessageSSH1> getPreparator(SshContext sshContext) {
        return new RsaAuthMessageSSHV1Preparator(sshContext.getChooser(), this);
    }

    @Override
    public Ssh1MessageSerializer<RsaAuthMessageSSH1> getSerializer(SshContext sshContext) {
