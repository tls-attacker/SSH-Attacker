...
public class HybridKeyExchangeReplyMessageSerializer
    ...
    public HybridKeyExchangeReplyMessageSerializer(HybridKeyExchangeReplyMessage message) {
        super(message);
    }
    ...
    private void serializePublicValues() {
        appendInt(
        ...
        LOGGER.debug(
                "Public values: {}",
                ArrayConverter.bytesToRawHexString(message.getPublicValues().getValue()));
    }
