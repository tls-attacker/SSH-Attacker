...
public class ChannelCloseMessageSSHV1Handler extends Ssh1MessageHandler<ChannelCloseMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelCloseMessageSSHV1Handler(SshContext sshContext) {
        super(sshContext);
    }
