...
public class ChannelCloseMessageSSHV1Serializier extends SshMessageSerializer<ChannelCloseMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelCloseMessageSSHV1Serializier(ChannelCloseMessageSSH1 message) {
        super(message);
    }
