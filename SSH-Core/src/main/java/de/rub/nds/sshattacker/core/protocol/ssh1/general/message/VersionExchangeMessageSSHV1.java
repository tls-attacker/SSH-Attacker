...
import de.rub.nds.sshattacker.core.protocol.ssh1.general.handler.VersionExchangeMessageSSHV1Handler;
import de.rub.nds.sshattacker.core.protocol.ssh1.general.parser.VersionExchangeMessageSSHV1Parser;
import de.rub.nds.sshattacker.core.protocol.ssh1.general.preparator.VersionExchangeMessageSSHV1Preparator;
import de.rub.nds.sshattacker.core.protocol.ssh1.general.serializer.VersionExchangeMessageSSHV1Serializer;
...
public class VersionExchangeMessageSSHV1 extends ProtocolMessage<VersionExchangeMessageSSHV1> {
    ...
    @Override
    public VersionExchangeMessageSSHV1Handler getHandler(SshContext sshContext) {
        return new VersionExchangeMessageSSHV1Handler(sshContext);
    }
    ...
    @Override
    public VersionExchangeMessageSSHV1Preparator getPreparator(SshContext sshContext) {
        return new VersionExchangeMessageSSHV1Preparator(sshContext.getChooser(), this);
    }

    @Override
    public VersionExchangeMessageSSHV1Serializer getSerializer(SshContext sshContext) {
        return new VersionExchangeMessageSSHV1Serializer(this);
    }

    @Override
    public String toShortString() {
        return "VESION_EXCHANGE_SSH1";
    }
}
