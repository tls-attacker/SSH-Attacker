...
public class X509DsaPublicKeyParser extends Parser<SshPublicKey<CustomX509DsaPublicKey, CustomDsaPrivateKey>> {
    ...
    public SshPublicKey<CustomX509DsaPublicKey, CustomDsaPrivateKey> parse() {
        try {
            ...
            if (publicKey instanceof DSAPublicKey) {
                ...
                CustomX509DsaPublicKey customX509DsaPublicKey = new CustomX509DsaPublicKey(dsaPublicKey, signature);
