...
import de.rub.nds.sshattacker.core.data.sftp.message.extended.SftpRequestStatVfsMessage;
import de.rub.nds.sshattacker.core.data.sftp.parser.extended.SftpRequestStatVfsMessageParser;
import de.rub.nds.sshattacker.core.data.sftp.preperator.extended.SftpRequestStatVfsMessagePreparator;
import de.rub.nds.sshattacker.core.data.sftp.serializer.extended.SftpRequestStatVfsMessageSerializer;
import de.rub.nds.sshattacker.core.state.SshContext;

public class SftpRequestStatVfsMessageHandler
        extends SftpMessageHandler<SftpRequestStatVfsMessage> {
    ...
    public void adjustContext() {
        // TODO: Handle SftpRequestStatVfsMessage
    }
