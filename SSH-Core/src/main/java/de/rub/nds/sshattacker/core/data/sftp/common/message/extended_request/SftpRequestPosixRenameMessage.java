...
import de.rub.nds.sshattacker.core.data.sftp.common.handler.extended_request.SftpRequestPosixRenameMessageHandler;
...
public class SftpRequestPosixRenameMessage
    ...
    public void setNewPath(String newPath, boolean adjustLengthField) {
        this.newPath = ModifiablePath.safelySetValue(this.newPath, newPath);
        if (adjustLengthField) {
