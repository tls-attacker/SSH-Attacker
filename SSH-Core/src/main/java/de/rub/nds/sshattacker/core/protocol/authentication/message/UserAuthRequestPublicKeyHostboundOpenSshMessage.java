...
public class UserAuthRequestPublicKeyHostboundOpenSshMessage
        extends UserAuthRequestMessage<UserAuthRequestPublicKeyHostboundOpenSshMessage> {
    ...
    private ModifiableInteger serverHostKeyBlobLength;
    ...
    public ModifiableInteger getServerHostKeyBlobLength() {
        return serverHostKeyBlobLength;
    }

    public void setServerHostKeyBlobLength(ModifiableInteger serverHostKeyBlobLength) {
        this.serverHostKeyBlobLength = serverHostKeyBlobLength;
    }

    public void setServerHostKeyBlobLength(int serverHostKeyBlobLength) {
        this.serverHostKeyBlobLength =
                ModifiableVariableFactory.safelySetValue(
                        this.serverHostKeyBlobLength, serverHostKeyBlobLength);
    }

    public ModifiableByteArray getServerHostKeyBlob() {
        return serverHostKeyBlob;
    }

    public void setServerHostKeyBlob(ModifiableByteArray serverHostKeyBlob) {
        setServerHostKeyBlob(serverHostKeyBlob, false);
    }

    public void setServerHostKeyBlob(byte[] serverHostKeyBlob) {
        setServerHostKeyBlob(serverHostKeyBlob, false);
    }

    public void setServerHostKeyBlob(
            ModifiableByteArray serverHostKeyBlob, boolean adjustLengthField) {
        this.serverHostKeyBlob = serverHostKeyBlob;
        if (adjustLengthField) {
            setServerHostKeyBlobLength(this.serverHostKeyBlob.getValue().length);
        }
    }

    public void setServerHostKeyBlob(byte[] serverHostKeyBlob, boolean adjustLengthField) {
        this.serverHostKeyBlob =
                ModifiableVariableFactory.safelySetValue(this.serverHostKeyBlob, serverHostKeyBlob);
        if (adjustLengthField) {
            setServerHostKeyBlobLength(this.serverHostKeyBlob.getValue().length);
        }
    }
