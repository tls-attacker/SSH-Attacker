 ...
 */
public class UnpackedDsaJavaSignature extends JavaSignature {
    ...
    private byte[] unpackSignature(byte[] packedSignature) {
    ...
    private byte[] packSignature(byte[] unpackedSignature) {
        BigInteger r =
                new BigInteger(
