...
public class ChannelOpenConfirmationMessageSSHV1Serializier extends SshMessageSerializer<ChannelOpenConfirmationMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelOpenConfirmationMessageSSHV1Serializier(ChannelOpenConfirmationMessageSSH1 message) {
        super(message);
    }
