...
public class ChannelOpenConfirmationMessageSSHV1Handler
        extends Ssh1MessageHandler<ChannelOpenConfirmationMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelOpenConfirmationMessageSSHV1Handler(SshContext sshContext) {
        super(sshContext);
    }
    ...
    public void adjustContext(ChannelOpenConfirmationMessageSSH1 message) {
        LOGGER.warn(
                "Recieved Channel Open Confirmation with remote Channel {} and local Channel",
