...
import de.rub.nds.sshattacker.core.data.sftp.common.handler.extended_request.SftpRequestCheckFileNameMessageHandler;
...
public class SftpRequestCheckFileNameMessage
    ...
    public SftpRequestCheckFileNameMessage() {
        super();
    }

    public SftpRequestCheckFileNameMessage(SftpRequestCheckFileNameMessage other) {
        super(other);
    ...
    @Override
    public SftpRequestCheckFileNameMessage createCopy() {
        return new SftpRequestCheckFileNameMessage(this);
    }
    ...
    public void prepare(Chooser chooser) {
        SftpRequestCheckFileNameMessageHandler.PREPARATOR.prepare(this, chooser);
    }

    @Override
    public byte[] serialize() {
        return SftpRequestCheckFileNameMessageHandler.SERIALIZER.serialize(this);
    }
}
