...
public class ChannelOpenConfirmationMessageSSHV1Preparator extends SshMessagePreparator<ChannelOpenConfirmationMessageSSH1> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelOpenConfirmationMessageSSHV1Preparator(Chooser chooser, ChannelOpenConfirmationMessageSSH1 message) {
