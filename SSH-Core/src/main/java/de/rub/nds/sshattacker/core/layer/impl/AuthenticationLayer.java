...
public class AuthenticationLayer extends ProtocolLayer<LayerProcessingHint, ProtocolMessage> {

    private static final Logger LOGGER = LogManager.getLogger();
    private SshContext context;

    public AuthenticationLayer(SshContext context) {
        super(ImplementedLayers.AuthenticationLayer);
