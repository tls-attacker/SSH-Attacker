...
public class ChannelOpenConfirmationMessagePreparator
    ...
    protected void prepareMessageSpecificContents(
        ...
        if (channel != null) {
            ...
            object.setInitialWindowSize(channel.getLocalWindowSize().getValue());
            object.setMaximumPacketSize(channel.getLocalPacketSize().getValue());
        } else {
            ChannelDefaults channelDefaults = chooser.getConfig().getChannelDefaults();
            object.setInitialWindowSize(channelDefaults.getLocalWindowSize());
            object.setMaximumPacketSize(channelDefaults.getLocalPacketSize());
        }
    }
}
