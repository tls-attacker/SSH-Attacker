...
public class BinaryPacketPreparatorSSHv1 extends AbstractPacketPreparator<BinaryPacketSSHv1> {
    ...
    public BinaryPacketPreparatorSSHv1(
            Chooser chooser,
            BinaryPacketSSHv1 binaryPacket,
