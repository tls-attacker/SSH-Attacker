...
public class UserAuthRequestHostbasedMessageParser
        extends UserAuthRequestMessageParser<UserAuthRequestHostbasedMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public UserAuthRequestHostbasedMessageParser(byte[] array) {
        super(array);
    }

    public UserAuthRequestHostbasedMessageParser(byte[] array, int startPosition) {
        super(array, startPosition);
    }

    @Override
    protected UserAuthRequestHostbasedMessage createMessage() {
        return new UserAuthRequestHostbasedMessage();
    }
