...
public class R {
    ...
    public R(SntrupParameterSet set, long[] coefficient) {
        ...
        this.r = UnivariateDivision.remainder(UnivariatePolynomialZ64.create(coefficient), mod,false);
    }
    ...
    public static R multiply(R r1, R r2) {
        return new R(r1.set,UnivariateDivision.remainder(r1.getR().multiply(r2.getR()), r1.getMod(),true));
    }
