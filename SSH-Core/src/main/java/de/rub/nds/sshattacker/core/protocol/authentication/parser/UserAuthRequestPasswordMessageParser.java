...
public class UserAuthRequestPasswordMessageParser
        extends UserAuthRequestMessageParser<UserAuthRequestPasswordMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public UserAuthRequestPasswordMessageParser(byte[] array) {
        super(array);
    }

    public UserAuthRequestPasswordMessageParser(byte[] array, int startPosition) {
        super(array, startPosition);
    }

    @Override
    public UserAuthRequestPasswordMessage createMessage() {
        return new UserAuthRequestPasswordMessage();
    }
