...
public class SuccessMessageParser extends SshMessageParser<SuccessMessage> {
    ...
    @Override
    protected void parseMessageSpecificContents(SuccessMessage message) {}

    @Override
    public void parse(SuccessMessage message) {
