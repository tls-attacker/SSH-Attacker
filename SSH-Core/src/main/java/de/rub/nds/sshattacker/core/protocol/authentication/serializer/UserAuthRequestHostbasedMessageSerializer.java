...
public class UserAuthRequestHostbasedMessageSerializer
        extends UserAuthRequestMessageSerializer<UserAuthRequestHostbasedMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public UserAuthRequestHostbasedMessageSerializer(UserAuthRequestHostbasedMessage message) {
        super(message);
    }
