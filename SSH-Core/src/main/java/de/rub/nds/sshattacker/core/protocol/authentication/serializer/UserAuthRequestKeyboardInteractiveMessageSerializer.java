...
public class UserAuthRequestKeyboardInteractiveMessageSerializer
        extends UserAuthRequestMessageSerializer<UserAuthRequestKeyboardInteractiveMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public UserAuthRequestKeyboardInteractiveMessageSerializer(
            UserAuthRequestKeyboardInteractiveMessage message) {
        super(message);
    }
