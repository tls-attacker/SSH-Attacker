...
public enum EncryptionAlgorithm {
    ...
    BLOWFISH_CBC("blowfish-cbc", EncryptionAlgorithmType.BLOCK, 16, 8, "Blowfish/CBC/NoPadding"),
    TWOFISH256_CBC(
            "twofish256-cbc", EncryptionAlgorithmType.BLOCK, 32, 16, "Twofish/CBC/NoPadding"),
    // This is an alias for twofish256-cbc
    TWOFISH_CBC("twofish-cbc", EncryptionAlgorithmType.BLOCK, 32, 16, "Twofish/CBC/NoPadding"),
    TWOFISH192_CBC(
            "twofish192-cbc", EncryptionAlgorithmType.BLOCK, 24, 16, "Twofish/CBC/NoPadding"),
    TWOFISH128_CBC(
            "twofish128-cbc", EncryptionAlgorithmType.BLOCK, 16, 16, "Twofish/CBC/NoPadding"),
    AES256_CBC("aes256-cbc", EncryptionAlgorithmType.BLOCK, 32, 16, "AES/CBC/NoPadding"),
    AES192_CBC("aes192-cbc", EncryptionAlgorithmType.BLOCK, 24, 16, "AES/CBC/NoPadding"),
    AES128_CBC("aes128-cbc", EncryptionAlgorithmType.BLOCK, 16, 16, "AES/CBC/NoPadding"),
    SERPENT256_CBC(
            "serpent256-cbc", EncryptionAlgorithmType.BLOCK, 32, 16, "Serpent/CBC/NoPadding"),
    SERPENT192_CBC(
            "serpent192-cbc", EncryptionAlgorithmType.BLOCK, 24, 16, "Serpent/CBC/NoPadding"),
    SERPENT128_CBC(
    ...
    AES256_CTR("aes256-ctr", EncryptionAlgorithmType.BLOCK, 32, 16, "AES/CTR/NoPadding"),
    TRIPLE_DES_CTR("3des-ctr", EncryptionAlgorithmType.BLOCK, 24, 8, "DESede/CTR/NoPadding"),
    BLOWFISH_CTR("blowfish-ctr", EncryptionAlgorithmType.BLOCK, 16, 8, "Blowfish/CTR/NoPadding"),
    TWOFISH128_CTR(
            "twofish128-ctr", EncryptionAlgorithmType.BLOCK, 16, 16, "Twofish/CTR/NoPadding"),
    TWOFISH192_CTR(
            "twofish192-ctr", EncryptionAlgorithmType.BLOCK, 24, 16, "Twofish/CTR/NoPadding"),
    TWOFISH256_CTR(
            "twofish256-ctr", EncryptionAlgorithmType.BLOCK, 32, 16, "Twofish/CTR/NoPadding"),
    SERPENT128_CTR(
            "serpent128-ctr", EncryptionAlgorithmType.BLOCK, 16, 16, "Serpent/CTR/NoPadding"),
    SERPENT192_CTR(
            "serpent192-ctr", EncryptionAlgorithmType.BLOCK, 24, 16, "Serpent/CTR/NoPadding"),
    SERPENT256_CTR(
            "serpent256-ctr", EncryptionAlgorithmType.BLOCK, 32, 16, "Serpent/CTR/NoPadding"),
