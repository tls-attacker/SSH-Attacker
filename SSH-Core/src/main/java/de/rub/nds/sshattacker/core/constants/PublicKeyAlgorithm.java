...
public enum PublicKeyAlgorithm {
    ...
    X509V3_SSH_RSA("x509v3-ssh-rsa", PublicKeyFormat.X509V3_SSH_RSA, SignatureEncoding.SSH_RSA, "SHA1WithRSA"),
    X509V3_RSA2048_SHA256("x509v3-rsa2048-sha256", PublicKeyFormat.X509V3_RSA2048_SHA256, SignatureEncoding.RSA2048_SHA256, "SHA256WithRSA"),
    X509V3_ECDSA_SHA2_SECP160K1(
            "x509v3-ecdsa-sha2-1.3.132.0.9",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP160K1,
            SignatureEncoding.ECDSA_SHA2_SECP160K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP160R1(
            "x509v3-ecdsa-sha2-1.3.132.0.8",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP160R1,
            SignatureEncoding.ECDSA_SHA2_SECP160R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP160R2(
            "x509v3-ecdsa-sha2-1.3.132.0.30",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP160R2,
            SignatureEncoding.ECDSA_SHA2_SECP160R2,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP192K1(
            "x509v3-ecdsa-sha2-1.3.132.0.31",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP192K1,
            SignatureEncoding.ECDSA_SHA2_SECP192K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP192R1(
            "x509v3-ecdsa-sha2-1.2.840.10045.3.1.1",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP192R1,
            SignatureEncoding.ECDSA_SHA2_SECP192R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP224K1(
            "x509v3-ecdsa-sha2-1.3.132.0.32",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP224K1,
            SignatureEncoding.ECDSA_SHA2_SECP224K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP224R1(
            "x509v3-ecdsa-sha2-1.3.132.0.33",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP224R1,
            SignatureEncoding.ECDSA_SHA2_SECP224R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECP256K1(
            "x509v3-ecdsa-sha2-1.3.132.0.10",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECP256K1,
            SignatureEncoding.ECDSA_SHA2_SECP256K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_NISTP256(
            "x509v3-ecdsa-sha2-nistp256",
            PublicKeyFormat.X509V3_ECDSA_SHA2_NISTP256,
            SignatureEncoding.ECDSA_SHA2_NISTP256,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_NISTP384(
            "x509v3-ecdsa-sha2-nistp384",
            PublicKeyFormat.X509V3_ECDSA_SHA2_NISTP384,
            SignatureEncoding.ECDSA_SHA2_NISTP384,
            "SHA384withECDSA"),
    X509V3_ECDSA_SHA2_NISTP521(
            "x509v3-ecdsa-sha2-nistp521",
            PublicKeyFormat.X509V3_ECDSA_SHA2_NISTP521,
            SignatureEncoding.ECDSA_SHA2_NISTP521,
            "SHA512withECDSA"),
    X509V3_ECDSA_SHA2_SECT163K1(
            "x509v3-ecdsa-sha2-1.3.132.0.1",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT163K1,
            SignatureEncoding.ECDSA_SHA2_SECT163K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT163R1(
            "x509v3-ecdsa-sha2-1.3.132.0.2",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT163R1,
            SignatureEncoding.ECDSA_SHA2_SECT163R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT163R2(
            "x509v3-ecdsa-sha2-1.3.132.0.15",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT163R2,
            SignatureEncoding.ECDSA_SHA2_SECT163R2,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT193R1(
            "x509v3-ecdsa-sha2-1.3.132.0.24",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT193R1,
            SignatureEncoding.ECDSA_SHA2_SECT193R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT193R2(
            "x509v3-ecdsa-sha2-1.3.132.0.25",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT193R2,
            SignatureEncoding.ECDSA_SHA2_SECT193R2,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT233K1(
            "x509v3-ecdsa-sha2-1.3.132.0.26",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT233K1,
            SignatureEncoding.ECDSA_SHA2_SECT233K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT233R1(
            "x509v3-ecdsa-sha2-1.3.132.0.27",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT233R1,
            SignatureEncoding.ECDSA_SHA2_SECT233R1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT239K1(
            "x509v3-ecdsa-sha2-1.3.132.0.3",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT239K1,
            SignatureEncoding.ECDSA_SHA2_SECT239K1,
            "SHA256withECDSA"),
    X509V3_ECDSA_SHA2_SECT283K1(
            "x509v3-ecdsa-sha2-1.3.132.0.16",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT283K1,
            SignatureEncoding.ECDSA_SHA2_SECT283K1,
            "SHA384withECDSA"),
    X509V3_ECDSA_SHA2_SECT283R1(
            "x509v3-ecdsa-sha2-1.3.132.0.17",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT283R1,
            SignatureEncoding.ECDSA_SHA2_SECT283R1,
            "SHA384withECDSA"),
    X509V3_ECDSA_SHA2_SECT409K1(
            "x509v3-ecdsa-sha2-1.3.132.0.36",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT409K1,
            SignatureEncoding.ECDSA_SHA2_SECT409K1,
            "SHA512withECDSA"),
    X509V3_ECDSA_SHA2_SECT409R1(
            "x509v3-ecdsa-sha2-1.3.132.0.37",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT409R1,
            SignatureEncoding.ECDSA_SHA2_SECT409R1,
            "SHA512withECDSA"),
    X509V3_ECDSA_SHA2_SECT571K1(
            "x509v3-ecdsa-sha2-1.3.132.0.38",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT571K1,
            SignatureEncoding.ECDSA_SHA2_SECT571K1,
            "SHA512withECDSA"),
    X509V3_ECDSA_SHA2_SECT571R1(
            "x509v3-ecdsa-sha2-1.3.132.0.39",
            PublicKeyFormat.X509V3_ECDSA_SHA2_SECT571R1,
            SignatureEncoding.ECDSA_SHA2_SECT571R1,
            "SHA512withECDSA"),
    ...
    X509V3_ECDSA_SHA2_BRAINPOOL_P512R1(
            ...
            SignatureEncoding.ECDSA_SHA2_BRAINPOOL_P512R1,
            "SHA512withECDSA"),
    X509V3_SSH_ED25519("x509v3-ssh-ed25519", PublicKeyFormat.X509V3_SSH_ED25519, SignatureEncoding.SSH_ED25519, "Ed25519"),
    // [ RFC 8709 ]
    SSH_ED25519(
