...
public class Sntrup761X25519KeyExchangeInitMessagePreperator
    ...
    public Sntrup761X25519KeyExchangeInitMessagePreperator(Chooser chooser, Sntrup761X25519KeyExchangeInitMessage message) {
    ...
    public void prepareMessageSpecificContents() {
        ...
        chooser.getContext().getExchangeHashInputHolder().setSntrupX25519ClientPublicKey(ArrayConverter.concatenate(pubKsntrup761,pubKec25519));
