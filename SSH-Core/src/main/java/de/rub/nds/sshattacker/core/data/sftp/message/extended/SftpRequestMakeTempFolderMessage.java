...
import de.rub.nds.sshattacker.core.data.sftp.handler.extended.SftpRequestMakeTempFolderMessageHandler;
...
public class SftpRequestMakeTempFolderMessage
    ...
    public SftpRequestMakeTempFolderMessageHandler getHandler(SshContext context) {
        return new SftpRequestMakeTempFolderMessageHandler(context);
    }
}
