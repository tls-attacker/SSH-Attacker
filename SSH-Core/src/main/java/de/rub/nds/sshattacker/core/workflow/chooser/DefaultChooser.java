...
public class DefaultChooser extends Chooser {
     ...
     * exchange is available, a new DH key exchange object will be constructed using the negotiated
         ...
         */
        @Override
        public Sntrup761X25519KeyExchange getSntrup761X25591KeyExchange() {
                return context.getSntrup761X25519KeyExchangeInstance()
                                .orElseGet(
                                                () -> {
                                                        Sntrup761X25519KeyExchange sntrupX25519 = new Sntrup761X25519KeyExchange();
                                                        context.setSntrup761X25519KeyExchangeInstance(sntrupX25519);
                                                        return sntrupX25519;
                                                });
        }
