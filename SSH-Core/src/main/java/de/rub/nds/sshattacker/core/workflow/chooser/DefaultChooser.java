...
import de.rub.nds.sshattacker.core.crypto.kex.Sntrup761KeyExchange;
...
/**
 * A default implementation of the abstract Chooser class. Values will be
 * primarily provided from
 * context or, if no context value is available, from the provided Config
 * instance. The JavaDoc of
 * each Chooser method provides detailed information on the Config fallback
...
public class DefaultChooser extends Chooser {
        ...
        /**
         * Constructs a new instance of the DefaultChooser class with the given context
         * and config.
         *
        ...
        /**
         * Retrieves the client version string from context. If no version string was
         * received (i.e.
         * out-of-order workflow or SSH-Attacker is running in client mode), the client
         * version string
        ...
        /**
         * Retrieves the client comment string from context. If no comment string was
         * received (i.e.
         * out-of-order workflow or SSH-Attacker is running in client mode), the client
         * comment string
         * from config will be returned.
        ...
        /**
         * Retrieves the client end-of-message sequence from context. If no such
         * sequence was received
         * (i.e. out-of-order workflow or SSH-Attacker is running in client mode), the
         * client
        ...
        /**
         * Retrieves the server version string from context. If no version string was
         * received (i.e.
         * out-of-order workflow or SSH-Attacker is running in server mode), the server
         * version string
         * from config will be returned.
         *
        ...
        /**
         * Retrieves the server comment string from context. If no comment string was
         * received (i.e.
         * out-of-order workflow or SSH-Attacker is running in server mode), the server
         * comment string
         * from config will be returned.
        ...
        /**
         * Retrieves the server end-of-message sequence from context. If no such
         * sequence was received
         * (i.e. out-of-order workflow or SSH-Attacker is running in server mode), the
         * server
         * end-of-message sequence from config will be returned.
         *
        ...
        /**
         * Retrieves the client cookie from context. If no cookie was received (i. e.
         * out-of-order
         * workflow or SSH-Attacker is running in client mode), the client cookie from
         * config will be
         * returned instead.
         *
        ...
        /**
         * Retrieves the server cookie from context. If no cookie was received (i. e.
         * out-of-order
         * workflow or SSH-Attacker is running in server mode), the server cookie from
         * config will be
         * returned instead.
         *
        ...
        /**
         * Retrieves the list of key exchange algorithms supported by the server from
         * context. If no
         * SSH_MSG_KEXINIT packet was received yet or SSH-Attacker is running in client
         * mode, the client
         ...
         * Retrieves the list of key exchange algorithms supported by the server from
         * context. If no
         * SSH_MSG_KEXINIT packet was received yet or SSH-Attacker is running in server
         * mode, the server
         * supported key exchange algorithms from config will be returned instead.
         *
        ...
        /**
         * Retrieves the list of host key algorithms supported by the client from
         * context. If no
         * SSH_MSG_KEXINIT packet was received yet or SSH-Attacker is running in client
         * mode, the client
        ...
        /**
         * Retrieves the list of host key algorithms supported by the server from
         * context. If no
         * SSH_MSG_KEXINIT packet was received yet or SSH-Attacker is running in server
         * mode, the server
         * supported host key algorithms from config will be returned instead.
        ...
        /**
         * Retrieves the list of encryption algorithms supported by the client for
         * client to server
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in client mode, the list of client supported client to server
         * encryption algorithms
         * from config will be returned instead.
         *
         * @return A list of encryption algorithms for client to server communication
         *         supported by the
         *         client
         */
        @Override
         ...
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in client mode, the list of client supported server to client
         * encryption algorithms
         * from config will be returned instead.
         *
         * @return A list of encryption algorithms for server to client communication
         *         supported by the
         *         client
         */
        @Override
        ...
        /**
         * Retrieves the list of encryption algorithms supported by the server for
         * server to client
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in server mode, the list of server supported server to client
         * encryption algorithms
         * from config will be returned instead.
         *
         * @return A list of encryption algorithms for server to client communication
         ...
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in server mode, the list of server supported client to server
         * encryption algorithms
         * from config will be returned instead.
         *
         * @return A list of encryption algorithms for client to server communication
        ...
        /**
         * Retrieves the list of MAC algorithms supported by the client for client to
         * server
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in client mode, the list of client supported client to server MAC
         * algorithms from
         * config will be returned instead.
         *
         * @return A list of MAC algorithms for client to server communication supported
         *         by the client
         */
        @Override
        ...
        /**
         * Retrieves the list of MAC algorithms supported by the client for server to
         * client
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in client mode, the list of client supported server to client MAC
         * algorithms from
         * config will be returned instead.
         *
         * @return A list of MAC algorithms for server to client communication supported
         *         by the client
         */
        @Override
        ...
        /**
         * Retrieves the list of MAC algorithms supported by the server for server to
         * client
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in server mode, the list of server supported server to client MAC
         * algorithms from
         * config will be returned instead.
         *
         * @return A list of MAC algorithms for server to client communication supported
        ...
        /**
         * Retrieves the list of MAC algorithms supported by the server for client to
         * server
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in server mode, the list of server supported client to server MAC
         * algorithms from
         * config will be returned instead.
         *
         * @return A list of MAC algorithms for client to server communication supported
        ...
        /**
         * Retrieves the list of compression algorithms supported by the client for
         * client to server
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in client mode, the list of client supported client to server
         ...
         * from config will be returned instead.
         *
         * @return A list of compression algorithms for client to server communication
         *         supported by the
         *         client
         */
        @Override
         ...
         * from config will be returned instead.
         *
         * @return A list of compression algorithms for server to client communication
         *         supported by the
         *         client
         */
        @Override
        ...
        /**
         * Retrieves the list of compression algorithms supported by the server for
         * server to client
         * communication from context. If no SSH_MSG_KEXINIT packet was received yet or
         * SSH-Attacker is
         * running in server mode, the list of server supported server to client
        ...
        /**
         * Retrieves the list of languages supported by the client for client to server
         * communication
         * from context. If no SSH_MSG_KEXINIT packet was received yet or SSH-Attacker
         * is running in
         * client mode, the list of client supported client to server languages from
         * config will be
         * returned instead.
         *
         * @return A list of languages for client to server communication supported by
         *         the client
         */
        @Override
        ...
        /**
         * Retrieves the list of languages supported by the client for server to client
         * communication
         * from context. If no SSH_MSG_KEXINIT packet was received yet or SSH-Attacker
         * is running in
         * client mode, the list of client supported server to client languages from
         * config will be
         * returned instead.
         *
         * @return A list of languages for server to client communication supported by
         *         the client
         */
        @Override
        ...
        /**
         * Retrieves the list of languages supported by the server for server to client
         * communication
         * from context. If no SSH_MSG_KEXINIT packet was received yet or SSH-Attacker
         * is running in
         * server mode, the list of server supported server to client languages from
         * config will be
         * returned instead.
         *
         * @return A list of languages for server to client communication supported by
        ...
        /**
         * Retrieves the list of languages supported by the server for client to server
         * communication
         * from context. If no SSH_MSG_KEXINIT packet was received yet or SSH-Attacker
         * is running in
         * server mode, the list of server supported client to server languages from
         * config will be
         * returned instead.
         *
         * @return A list of languages for client to server communication supported by
        ...
        /**
         * Retrieves the value of the guessed key exchange flag as included in the
         * clients
         * SSH_MSG_KEXINIT packet from context. If no SSH_MSG_KEXINIT packet was
         * received yet or
         * SSH-Attacker is running in client mode, the value from config will be
         * returned instead.
         *
         * @return A boolean flag indicating whether the client will initiate a guessed
         *         key exchange by
         *         sending the first key exchange packet ahead of time. For details see
         *         RFC 4253 Section
         *         7.1.
         */
        @Override
         ...
         * SSH_MSG_KEXINIT packet from context. If no SSH_MSG_KEXINIT packet was
         * received yet or
         * SSH-Attacker is running in server mode, the value from config will be
         * returned instead.
         *
         * @return A boolean flag indicating whether the server will initiate a guessed
         *         key exchange by
         *         sending the first key exchange packet ahead of time. For details see
         *         RFC 4253 Section
         *         7.1.
        ...
        /**
         * Retrieves the value of the reserved field as included in the clients
        ...
        /**
         * Retrieves the value of the reserved field as included in the servers
         * SSH_MSG_KEXINIT packet
         * from context. If no SSH_MSG_KEXINIT packet was received yet or SSH-Attacker
         * is running in
        ...
        /**
         * Retrieves the negotiated key exchange algorithm from context. If the field is
         * not set in
         * context, this method will try to pick the negotiated algorithm according to
         * RFC 4253 based on
         * the lists of supported algorithms and update the context accordingly. If the
         * supported
         * algorithms lists of client and server do not intersect, this method will
         * return the first
        ...
        public KeyExchangeAlgorithm getKeyExchangeAlgorithm() {
                return context.getKeyExchangeAlgorithm()
                                .orElseGet(
                                                () -> {
                                                        KeyExchangeAlgorithm negotiatedAlgorithm = AlgorithmPicker
                                                                        .pickAlgorithm(
        ...
        /**
         * Retrieves the negotiated host key algorithm from context. If the field is not
         * set in context,
         * this method will try to pick the negotiated algorithm according to RFC 4253
         * based on the
         * lists of supported algorithms and update the context accordingly. If the
         * supported algorithms
         * lists of client and server do not intersect, this method will return the
         * first algorithm in
        ...
        public PublicKeyAlgorithm getHostKeyAlgorithm() {
                return context.getHostKeyAlgorithm()
                                .orElseGet(
                                                () -> {
                                                        PublicKeyAlgorithm negotiatedAlgorithm = AlgorithmPicker
                                                                        .pickAlgorithm(
        ...
        /**
         * Retrieves the negotiated encryption algorithm for client to server
         * communication from
         * context. If the field is not set in context, this method will try to pick the
         * negotiated
         * algorithm according to RFC 4253 based on the lists of supported algorithms
         * and update the
         * context accordingly. If the supported algorithms lists of client and server
         * do not intersect,
         * this method will return the first algorithm in the list sent by SSH-Attacker.
         *
         * @return The negotiated encryption algorithm for client to server
         *         communication
         */
        @Override
        public EncryptionAlgorithm getEncryptionAlgorithmClientToServer() {
                return context.getEncryptionAlgorithmClientToServer()
                                .orElseGet(
                                                () -> {
                                                        EncryptionAlgorithm negotiatedAlgorithm = AlgorithmPicker
                                                                        .pickAlgorithm(
                                                                                        this
        ...
        /**
         * Retrieves the negotiated encryption algorithm for server to client
         * communication from
         * context. If the field is not set in context, this method will try to pick the
         * negotiated
         * algorithm according to RFC 4253 based on the lists of supported algorithms
         ...
         * this method will return the first algorithm in the list sent by SSH-Attacker.
         *
         * @return The negotiated encryption algorithm for server to client
         *         communication
         */
        @Override
        ...
        /**
         * Retrieves the negotiated MAC algorithm for client to server communication
         * from context. If
         * the field is not set in context, this method will try to pick the negotiated
         * algorithm
         * according to RFC 4253 based on the lists of supported algorithms and update
         * the context
         * accordingly. If the supported algorithms lists of client and server do not
         * intersect, this
        ...
        public MacAlgorithm getMacAlgorithmClientToServer() {
                return context.getMacAlgorithmClientToServer()
                                .orElseGet(
                                                () -> {
                                                        MacAlgorithm negotiatedAlgorithm = AlgorithmPicker
                                                                        .pickAlgorithm(
                                                                                        this
        ...
        /**
         * Retrieves the negotiated MAC algorithm for server to client communication
         * from context. If
         * the field is not set in context, this method will try to pick the negotiated
         * algorithm
         * according to RFC 4253 based on the lists of supported algorithms and update
        ...
        /**
         * Retrieves the negotiated compression method for client to server
         * communication from context.
         * If the field is not set in context, this method will try to pick the
        ...
        public CompressionMethod getCompressionMethodClientToServer() {
                return context.getCompressionMethodClientToServer()
                                .orElseGet(
                                                () -> {
                                                        CompressionMethod negotiatedMethod = AlgorithmPicker
                                                                        .pickAlgorithm(
                                                                                        this
        ...
        /**
         * Retrieves the negotiated compression method for server to client
         * communication from context.
         * If the field is not set in context, this method will try to pick the
         * negotiated algorithm
         * according to RFC 4253 based on the lists of supported algorithms and update
        ...
        // region Key Exchange
        /**
         * Retrieve the DH key exchange object from context. If no DH key exchange is
         * available, a new
         * DH key exchange object will be constructed using the negotiated key exchange
         * algorithm and
        ...
        public DhKeyExchange getDhKeyExchange() {
                return context.getDhKeyExchangeInstance()
                                .orElseGet(
                                                () -> {
                                                        KeyExchangeAlgorithm negotiatedAlgorithm = this
                                                                        .getKeyExchangeAlgorithm();
                                                        DhKeyExchange freshKeyExchange = DhKeyExchange
                                                                        .newInstance(context, negotiatedAlgorithm);
        ...
        /**
         * Retrieve the DH GEX (group exchange) key exchange object from context. If no
         * DH GEX key
         * exchange is available, a new DH key exchange object will be constructed using
         * the negotiated
                ...
                return context.getHybridKeyExchangeInstance()
                                .orElseGet(
                                                () -> {
                                                        KeyExchangeAlgorithm negotiatedAlgorithm = this
                                                                        .getKeyExchangeAlgorithm();
                                                        HybridKeyExchange hybridKeyExchange = HybridKeyExchange
                                                                        .newInstance(context, negotiatedAlgorithm);
        ...
        /**
         * Retrieve the ECDH key exchange object from context. If no ECDH key exchange
         * is available, a
         * new ECDH key exchange object will be constructed using the negotiated key
         * exchange algorithm
        ...
        /**
         * Retrieve the RSA key exchange object from context. If no RSA key exchange is
         * available, a new
         * RSA key exchange object will be constructed using the negotiated key exchange
         * algorithm and
         * the context will be updated accordingly.
         *
                ...
                return context.getRsaKeyExchangeInstance()
                                .orElseGet(
                                                () -> {
                                                        KeyExchangeAlgorithm negotiatedAlgorithm = this
                                                                        .getKeyExchangeAlgorithm();
                                                        RsaKeyExchange freshKeyExchange = RsaKeyExchange
                                                                        .newInstance(context, negotiatedAlgorithm);
        ...
        /**
         * Pick and return the host key from config that is compatible with the
         * negotiated host key
         * algorithm. If multiple host keys of the same type are present, the first key
         * will be
         * returned. If no appropriate host key is configured, this method will return
         * the first key in
         * the list of host keys as a fallback.
         *
         * @return A host key matching the host key algorithms' key format. If no such
         *         host key is
         *         configured, the first key in the list of host keys will be returned
         *         as fallback.
         */
        @Override
        public SshPublicKey<?, ?> getNegotiatedHostKey() {
                ...
                return config.getHostKeys().stream()
                                .filter(
                                                hk -> hk.getPublicKeyFormat() == negotiatedHostKeyAlgorithm.get()
                                                                .getKeyFormat())
                                .findFirst()
                                .orElseGet(
                                                () -> {
        ...
        /**
         * Retrieves the minimal group size of the requested DH group during group
         * exchange.
         *
        ...
        /**
         * Retrieves the preferred group size of the requested DH group during group
         * exchange.
         *
        ...
        /**
         * Retrieves the maximal group size of the requested DH group during group
         * exchange.
         *
        ...
        /**
         * Retrieves the primary authentication method from config. A context field for
         * authentication
         * method does not yet exist as the authentication protocol is only implemented
         * for SSH-Attacker
         * in client mode.
         *
