...
public class ChannelRequestX11ReqMessageSerializer
        extends ChannelRequestMessageSerializer<ChannelRequestX11ReqMessage> {

    private static final Logger LOGGER = LogManager.getLogger();

    public ChannelRequestX11ReqMessageSerializer(ChannelRequestX11ReqMessage message) {
        super(message);
    }
