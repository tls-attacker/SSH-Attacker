...
import de.rub.nds.sshattacker.core.data.sftp.common.handler.request.SftpRequestSetStatMessageHandler;
...
public class SftpRequestSetStatMessage
    ...
    public static final SftpRequestSetStatMessageHandler HANDLER =
            new SftpRequestSetStatMessageHandler();

    @Override
    public SftpRequestSetStatMessageHandler getHandler() {
        return HANDLER;
    }
    ...
    public void prepare(Chooser chooser) {
        SftpRequestSetStatMessageHandler.PREPARATOR.prepare(this, chooser);
    }

    @Override
    public byte[] serialize() {
        return SftpRequestSetStatMessageHandler.SERIALIZER.serialize(this);
    }
