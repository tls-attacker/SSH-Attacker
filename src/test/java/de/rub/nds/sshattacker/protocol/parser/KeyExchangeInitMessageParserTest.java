...
public class KeyExchangeInitMessageParserTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays
                .asList(new Object[][] {
                        {
                                ArrayConverter
                                        .hexStringToByteArray(""),
    ...
    public void testParseMessageSpecificPayload() {
        ...
        assertEquals(encryptionAlgorithmsClientToServerLength, msg.getEncryptionAlgorithmsClientToServerLength()
                .getValue().intValue());
        assertEquals(encryptionAlgorithmsClientToServer, msg.getEncryptionAlgorithmsClientToServer().getValue());
        assertEquals(encryptionAlgorithmsServerToClientLength, msg.getEncryptionAlgorithmsServerToClientLength()
                .getValue().intValue());
        assertEquals(encryptionAlgorithmsServerToClient, msg.getEncryptionAlgorithmsServerToClient().getValue());
        assertEquals(macAlgorithmsClientToServerLength, msg.getMacAlgorithmsClientToServerLength().getValue()
                .intValue());
        assertEquals(macAlgorithmsClientToServer, msg.getMacAlgorithmsClientToServer().getValue());
        assertEquals(macAlgorithmsServerToClientLength, msg.getMacAlgorithmsServerToClientLength().getValue()
                .intValue());
        assertEquals(macAlgorithmsServerToClient, msg.getMacAlgorithmsServerToClient().getValue());
        assertEquals(compressionAlgorithmsClientToServerLength, msg.getCompressionAlgorithmsClientToServerLength()
                .getValue().intValue());
        assertEquals(compressionAlgorithmsClientToServer, msg.getCompressionAlgorithmsClientToServer().getValue());
        assertEquals(compressionAlgorithmsServerToClientLength, msg.getCompressionAlgorithmsServerToClientLength()
                .getValue().intValue());
